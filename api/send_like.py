...
def send_like():
    ...
    with ThreadPoolExecutor(max_workers=50) as executor:
        ...
        for future in as_completed(futures):
            ...
            res = future.result()
            # ✅ التحقق من النجاح بناءً على محتوى response_text
            if res["status_code"] == 200 and res["response_text"]:
                with lock:
    ...
    # إذا لم يتم إرسال أي لايك → وصل الحد اليومي
    if likes_sent == 0:
        return jsonify({
            ...
            "message": "Daily like limit reached or tokens cannot add likes",
            "success_tokens": [],
